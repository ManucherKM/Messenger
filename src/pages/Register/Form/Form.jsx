...
const Form = observer(({ setLoading }) => {
	...
	return (
		<form onClick={formSend} className="flex flex-col">
			...
			<Button text={'Вход'} onClick={register} type={'submit'} disabled={disableBtn} styles="mt-5" />
			<Link className="text-green text-sm font-medium mt-3 ml-auto hover:opacity-60" to="/">
				Авторизация
			</Link>
		</form>
	)
