	...
	return (
		...
		>
			<div className="flex-center">
				<div className="mr-4">
					<img src={vkLogo} alt="company-icon" className="w-8 phon:w-7 select-none" />
				</div>
				<div>
					<span className={`text-white tracking-wide select-none ${styleText}`}>Войти с помощью VK</span>
				</div>
			</div>
		</div>
	)
