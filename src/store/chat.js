	...
	chats = [
		...
		},
		{
			...
			friend: {
				...
				isTyping: false,
				urlImg:
					'https://plus.unsplash.com/premium_photo-1667511131806-5907723694fa?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8bWFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
			},
			user: {
				noCheck: 5,
			},
		...
		},
		{
			...
			friend: {
				...
				isTyping: false,
				urlImg:
					'https://images.unsplash.com/photo-1581382575275-97901c2635b7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8bWFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
			},
			user: {
				noCheck: 5,
			},
		...
		},
		{
			...
			friend: {
				...
				isTyping: false,
				urlImg:
					'https://images.unsplash.com/photo-1548449112-96a38a643324?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTF8fG1hbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
			},
			user: {
				noCheck: 5,
			},
		...
		},
		{
			...
			friend: {
				...
				isTyping: false,
				urlImg:
					'https://images.unsplash.com/photo-1590086782957-93c06ef21604?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTV8fG1hbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
			},
			user: {
				noCheck: 5,
			},
		...
		},
		{
			...
			friend: {
				...
				isTyping: false,
				urlImg:
					'https://images.unsplash.com/photo-1488161628813-04466f872be2?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fG1hbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
			},
			user: {
				noCheck: 5,
			},
		...
		},
		{
			...
			friend: {
				...
				isTyping: false,
				urlImg:
					'https://images.unsplash.com/photo-1600486913747-55e5470d6f40?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjB8fG1hbnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60',
			},
			user: {
				noCheck: 5,
			},
		...
		},
		{
			...
			friend: {
				...
				isTyping: false,
				urlImg:
					'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8bWFufGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60',
			},
			user: {
				noCheck: 0,
			},
        ...
        */
		...
		const response = {
			...
			friend: {
				id: 12,
				urlImg:
					'https://images.unsplash.com/photo-1668915658566-59bc6514a707?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=735&q=80',
				name: 'Tom Smith',
				isOnline: true,
				isTyping: false,
			},
