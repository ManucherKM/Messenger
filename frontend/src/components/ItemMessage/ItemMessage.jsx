    ...
    return (
        <div className="flex">
            <div className="relative w-1/4">
                ...
                {isOnline && <svg className="absolute left-[38px] bottom-1" width="12" height="12" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-2/4 flex flex-col justify-between">
                ...
                {!isTyping && <span className="text-base font-normal text-black/[.45]">{visibleMessage}</span>}
            ...
            <div className="w-1/4 flex flex-col items-end justify-between">
                <p className="text-base text-black[./65] text-right">{time}</p>
                {!isCheckMe &&
                    < div className="bg-green rounded-full w-5 h-5 flex items-center justify-center">
                        <span className="text-xs text-white">
                            {noCheck}
                        </span>
                    </div>
                }
                {isCheckMe && isSend && !isCheckFriend &&
