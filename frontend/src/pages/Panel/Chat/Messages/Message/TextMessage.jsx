const TextMessage = ({ message, time, isSend, isCheck, isUser }) => {
    return (
        <div>
            {isUser &&
                <div className="ml-[100px]">

                    <div className="bg-gray-200 cursor-default py-2 px-3 rounded-xl rounded-br-none my-4 flex flex-col items-end w-fit ml-auto">
                        <span className="text-base text-black break-word break-all">
                            {message}
                        </span>
            ...
            {!isUser &&
                <div className="bg-gray-200 cursor-default py-2 px-3 rounded-xl rounded-bl-none my-4 flex flex-col items-start w-fit mr-auto">
