...
const TypeMessage = observer(({ dropFile }) => {
  ...
  function send() {
    ...
    const obj = {
      userId: userController.config.info.id,
      message: message,
    }
